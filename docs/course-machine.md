...
![The precision hydraulic lift platform: a vertical cylinder raising a two-tonne load to a target height within plus or minus one millimetre, fed by a power unit through a 100 bar line](assets/course-machine.svg)
